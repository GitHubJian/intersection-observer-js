...
IntersectionObserver.prototype.takeRecords = function() {
  var records = this._queueEntries.slice()
  this._queueEntries = []
  return records
}

IntersectionObserver.prototype._initThresholds = function(iniThreshold) {
  var threshold = iniThreshold || [0]
...
IntersectionObserver.prototype._parseRootMargin = function(initRootMargin) {
  var marginString = initRootMargin || '0px'
...
IntersectionObserver.prototype._monitorIntersections = function() {
  if (!this._monitorIntersections) {
    this._monitorIntersections = true
...
IntersectionObserver.prototype._unmonitorIntersections = function() {
  if (this._monitorIntersections) {
    this._monitorIntersections = false
...
IntersectionObserver.prototype._checkForIntersections = function() {
  ...
  this._observationTargets.forEach(function(item) {
    ...
    if (!oldEntry) {
      this._queueEntries.push(newEntry)
